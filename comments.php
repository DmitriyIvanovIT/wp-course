        ...
        <?php if ('div' != $args['style']) { ?>
            ...
            <div class="comment-content">
                ...
                <div class="comment-reply">
                    <svg width="15" height="15" class="icon comments-add-icon">
    ...
    <div id="comments" class="comments-area">
        ...
        ?>
            <div class="comments-header">
                ...
                <!-- .comments-title -->
                <a href="#reply-title" class="comments-add-button">
                    <svg width="18" height="18" class="icon comments-add-icon">
                        <use xlink:href="<? echo get_template_directory_uri() ?>/assets/images/icons.svg#pencil"></use>
                    </svg>
            ...
            <ol class="comments-list">
                ...
                wp_list_comments(
                    array(
                        ...
                        'login_text' => 'Зарегистрируйтесь, если хотите оставить комментарий'
                    )
                );
                ?>
            </ol><!-- .comment-list -->
        ...
        comment_form(array(
            'comment_field' => '<div class="comment-form-comment"><label class="comment-label" for="comment">' . _x('Что вы думаете на этот счет?', 'noun') . '</label>
